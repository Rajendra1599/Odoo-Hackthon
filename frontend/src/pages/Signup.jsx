    ...
    <div className="flex min-h-screen items-center justify-center bg-canvas px-4">
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} noValidate className="card px-8 py-8">
          <h1 className="mb-6 text-lg font-bold text-ink-900">Create your account</h1>
          ...
          <div className="mb-6">
            ...
            <p className="mt-1 text-xs text-ink-500">
              This determines what you can view and manage in the app.
            </p>
          </div>
          ...
          <p className="mt-5 text-center text-sm text-ink-500">
            ...
            <Link to="/login" className="font-semibold text-route-500 hover:underline">
              Sign in
            </Link>
          </p>
        </form>
